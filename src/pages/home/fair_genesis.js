    ...
    <ModWrapper tid="genesis" >
      <Box>
        ...
        <Box fontSize={{ pc: "16px", base: "14px" }} fontWeight={500} color={"rgba(0, 0, 0, 0.6)"}>
          ...
          <p>This is a fair social experiment. The Genesis team owns 0 tokens. To own the token, the members must buy on the marketplace themselves.</p>
          <div><Link href="#"><HighLightText>Click on the tarot</HighLightText></Link> card  to view the detail distribution of genesis:</div>
        </Box>
        <Box marginTop="40px" >
