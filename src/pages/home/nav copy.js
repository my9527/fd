...
export default function WithSubnavigation() {
  ...
  const { isOpenDrawer, onOpen, onClose } = useDisclosure()
  const btnRef = React.useRef()

  return (
    <Box height={{ base: "80vw", pc: "42vw" }} padding={{ base: "0", pc: "0 120px" }} bgImage={BannerPc} bgSize="cover" bgRepeat="no-repeat">
      <Flex
        color={"white"}
        minH={'48vw'}
        py={{ base: 2 }}
